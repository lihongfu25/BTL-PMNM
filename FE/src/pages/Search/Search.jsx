...
import { Box, Grid, FormControlLabel, Checkbox, FormGroup, Button } from "@mui/material";
			...
			<Grid container spacing={{ xs: 2, md: 4 }} columns={{ xs: 4, sm: 8, md: 12 }}>
				...
				<Grid item xs={10}>
					...
					>
						...
						>
							<p>Sắp xếp theo:</p>
							<StyledButton className={sorting === "Liên Quan" ? "active" : ""} onClick={(e) => setSorting("Liên Quan")}>
								Liên Quan
							</StyledButton>
							<StyledButton className={sorting === "Mới Nhất" ? "active" : ""} onClick={(e) => setSorting("Mới Nhất")}>
								Mới Nhất
							</StyledButton>
							<StyledButton className={sorting === "Bán Chạy" ? "active" : ""} onClick={(e) => setSorting("Bán Chạy")}>
								Bán Chạy
							</StyledButton>
							<Box
							...
							>
								<span className="sort-value">
									{sorting === "ascending" ? "Giá: Thấp đến Cao" : sorting === "descending" ? "Giá: Cao đến Thấp" : "Giá"}
								</span>
								<span className="icon">
									<BsCaretDownFill />
								</span>
								...
								>
									<option className={sorting === "ascending" ? "active" : ""} value="ascending" onClick={handleSortPrice}>
										Giá: Thấp đến Cao
									</option>
									<option className={sorting === "descending" ? "active" : ""} value="descending" onClick={handleSortPrice}>
										Giá: Cao đến Thấp
									</option>
								</Box>
							</Box>
